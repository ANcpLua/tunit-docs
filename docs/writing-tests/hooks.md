...
For the full execution order, see [Test Lifecycle](/docs/writing-tests/lifecycle.md).
...
* [Test Lifecycle](/docs/writing-tests/lifecycle.md) — Full overview of the test execution lifecycle
* [Event Subscribing](/docs/writing-tests/event-subscribing.md) — Event receiver interfaces for advanced scenarios
