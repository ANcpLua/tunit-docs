...
* [Test Lifecycle](/docs/writing-tests/lifecycle.md) — Understand the order of setup, execution, and cleanup
* [Hooks](/docs/writing-tests/hooks.md) — Run code before and after tests, classes, or assemblies
* [Controlling Parallelism](/docs/execution/parallelism.md) — Configure how tests run in parallel
