...
For dynamic test data or complex objects, use [Method Data Sources](/docs/writing-tests/method-data-source.md) with [TestDataRow](/docs/writing-tests/test-data-row.md) for the same metadata capabilities.
