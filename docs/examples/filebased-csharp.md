...
4. **Run your tests**: You can run your tests by executing the script using `dotnet run`. The results will be printed to the console. To run the script, you can use the following command:
