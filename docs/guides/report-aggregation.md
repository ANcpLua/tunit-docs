...
* [HTML Test Report](/docs/guides/html-report.md) — the per-suite report and artifact upload
* [CI/CD Reporting](/docs/execution/ci-cd-reporting.md) — the GitHub Actions reporter
