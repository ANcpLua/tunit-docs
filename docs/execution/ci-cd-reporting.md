...
Running several test projects in one pipeline produces one summary section per project. To merge them into a single aggregated block (and a single combined HTML report), see [Aggregated Reports](/docs/guides/report-aggregation.md).
