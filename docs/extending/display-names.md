...
If you have custom classes, you can combine this with [Argument Formatters](/docs/extending/argument-formatters.md) to specify how to show them.
...
There you will find a method that you must override: `FormatDisplayName`. Here you have access to all the arguments and test details via the `TestContext` parameter.
